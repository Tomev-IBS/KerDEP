...
void Plot::setAxesLimit(const double &limit)
{
  ...
  setAxisScale(Qt::XAxis, -3, 3); // 11, 14, 24, for classical, slower and lazy paths. Pm 3 for v = 0
  setAxisScale(Qt::ZAxis, -6, 6); // 25, 31, 51, for classical, slower and lazy paths. Pm 6 for v = 0
}
