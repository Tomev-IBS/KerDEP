...
void MainWindow::Run1DExperimentWithDESDA() {
  ...
  QString expDesc = "id=" + QString::number(screen_generation_frequency_) + ", assumed trimodal data stream; -9 - 0 - 6";
  QString plot_description = "assumed trimodal data stream; -9 - 0 - 6";
