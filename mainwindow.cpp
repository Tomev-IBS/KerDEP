...
void MainWindow::on_pushButton_clicked() {
  ...
  QString expNum = "1316 (2D)";
  this->setWindowTitle("Experiment #" + expNum);
  QString expDesc =
      "iw=" + QString::number(screenGenerationFrequency) + ", v=tor na x_1, m0=200, mMin=400, (faster) rare test, sz001";
  QString driveDir = "\\\\beabourg\\private\\"; // WIT PCs
  //QString driveDir = "D:\\Test\\"; // Home
  //QString driveDir = "d:\\OneDrive - Instytut Badań Systemowych Polskiej Akademii Nauk\\"; // Local
  QString dirPath = driveDir + "TR Badania\\Eksperyment " + expNum + " ("
                    + expDesc + ")\\";
  if(!QDir(dirPath).exists()) QDir().mkdir(dirPath);
