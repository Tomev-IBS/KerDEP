...
void MainWindow::on_pushButton_clicked() {
  ...
  QString experiment_description = "Ścieżka zdrowia; v2=0.1v1";
  ...
  QString expNum = "1571 (2D)";
  this->setWindowTitle("Experiment #" + expNum);
  QString expDesc =
      "Ścieżka zdrowia 2D, v2=0.01, iw=" + QString::number(screen_generation_frequency_)
