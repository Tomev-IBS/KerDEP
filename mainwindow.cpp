  ...
  for(stepNumber = 1; stepNumber < stepsNumber; ++stepNumber)
  {
    ...
    if(stepNumber % 10 == 0)
    {
      ...
      */
      ...
      QString dirPath = "D:\\Dysk Google\\TR Badania\\Eksperyment 229 (w_EmE = "+ QString::number(DESDAAlgorithm.w_E) +", m_E=1000, m_Eta="+QString::number(DESDAAlgorithm._kpssM)+", x=8, seed="+ui->lineEdit_seed->text()+")\\";
