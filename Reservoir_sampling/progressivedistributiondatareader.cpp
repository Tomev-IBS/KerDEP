...
void progressiveDistributionDataReader::getNextRawDatum(void *target) {
  ...
  */
  ...
  // Stops at 0 + 4 + 1 = 5 without offset. Set maxY = 8.
  switch(_currentIteration - 1) { // For exps with seed, remove later
    case 0:
  ...
  //sourceDistribution->increaseMeans(x_progression_size * 0.5, 1);
  //_alternativeDistribution->increaseMeans(x_progression_size * 0.5, 1);
